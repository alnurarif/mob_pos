...
class Auth_model extends CI_Model
{
    ...
    public function login($identity, $password, $remember = false)
    {
        ...
        $query                 = $this->db->select($this->identity_column . ', username, email, id, password, active, last_login, last_ip_address, group_id')
    ...
    public function login_remembered_user()
    {
        ...
        $query = $this->db->select($this->identity_column . ', id, username, email, last_login, last_ip_address, group_id')
