 ...
 */
$config['site_title']                 = "Repairer Advance";       // Site Title, example.com This is not more functional
$config['admin_email']                = "contact@otsglobal.org"; // Admin Email, admin@example.com This is not more functional
