                ...
                <div class="row bold">
                    ...
                    <p class="bold">
                       <strong><?php echo lang("date"); ?>:</strong> <?php echo $this->repairer->hrld($inv->date); ?><br>
                        ...
                        <strong><?php echo lang('Tracking Number');?>:</strong> <?php echo ($inv->track_code) ? '<a target="_blank" href="https://www.packagemapping.com/track/auto/'.$inv->track_code.'">'.$inv->track_code.'</a>' : 'Not Available'; ?><br>
            ...
            <div class="row">
                ...
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <button data-refresh="true" href="#return_ship" data-num="<?php echo $inv->id; ?>" class="ship_return btn btn-primary">
                        ...
                        <div class="btn-group">
                            <button data-refresh="true" href="#return_accept" data-num="<?php echo $inv->id; ?>" class="return_accept btn btn-primary">
                                <i class="fas fa-plus-circle"></i> 
