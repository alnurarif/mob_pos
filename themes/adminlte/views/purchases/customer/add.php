                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select id="client_name" name="client_name" data-num="1" class="form-control m-bot15" style="width: 100%">
                                            <option disabled selected><?=lang('please_select');?></option>
                                            <?php 
                                                foreach ($clients as $client) :
                                                echo '<option value="'.$client->id.'">'.$client->first_name.' '.$client->last_name.' '.$client->company.'</option>';
                                                endforeach; 
                                            ?>
                                        </select>
                           ...
                           <legend><?php echo lang('Phone Information');?></legend>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo set_value('phone_name'); ?>" name="phone_name">
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="cosmetic_condition" required="">
                                            <option value="1">
                                                *
                                            </option>
                                            <option value="2">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="operational_condition" required="">
                                            <option value="1">
                                                *
                                            </option>
                                            <option value="2">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                ?>
                                                <?php echo form_dropdown('manufacturer', $models_dd, set_value('manufacturer'), 'class="form-control" id="manufacturer"'); ?>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo set_value('model'); ?>" name="model">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <?php echo lang('Status', 'phone_status');?>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        <?php echo lang('Unlocked', 'unlock_status');?>
                                        <select class="form-control" name="unlock_status" required="">
                                            <option value="0">
                                                <?php echo lang('no');?>
                                            </option>
                                            <option value="1">
