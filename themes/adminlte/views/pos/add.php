                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab-drepairs">
                            <?php if($drepairs): foreach($drepairs as $repair): ?>
                                <button data-type="drepair" value="<?php echo $repair->id; ?>" class="btn-pr btn btn-default"><span><?php echo character_limiter($repair->name, 80) ?></span></button>
                            <?php endforeach; endif;?>
                        </div>
                        <?php if($this->Admin || $GP['pos-purchase_phones']): ?>
            ...
            $.each(items, function () {
                ...
                if ((!this.refund_item)) {
                    <?php if($this->Admin || $GP['pos-add_discounts']): ?>
                        tr_html += ' <button id="' + row_no + '" data-item="' + item_id + '" data-price="' + price + '" title="'+"<?php echo lang('Edit');?>"+'" style="cursor:pointer;" class="discount btn btn-xs btn-primary"><i class="fas fa-pen" aria-hidden="false"></i></button>';
                    <?php endif; ?>
                }
                if (this.refund_item){
