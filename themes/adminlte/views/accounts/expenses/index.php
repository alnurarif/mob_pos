<a href="<?php echo base_url();?>panel/expenses/add" class="btn-icon btn btn-primary btn-icon">
    <i class="fa fa-plus"></i> <?php echo lang('Add Expense');?>
</a>
    ...
    <div class="box-body">
        <div class="table-responsive">
            <table style="width: 100%" class="display compact table table-bordered table-striped" id="dynamic-table">
                <thead>
                <tr>
                    <th><?php echo lang('Expense Type');?></th>
...
$(document).ready(function () {
    oTable = $('#dynamic-table').dataTable({
        ...
        'sAjaxSource': '<?php echo site_url('panel/expenses/getAllExpenses'); ?>',
