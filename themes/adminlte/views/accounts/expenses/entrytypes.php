<?php if($this->Admin || $GP['expense_type-add']): ?>
...
$(document).ready(function () {
    ...
    oTable = $('#entrytypes-table').dataTable({
      autoWidth: false,
        ...
        'sAjaxSource': '<?php echo site_url('panel/expenses/getAllEntryTypes/'); ?>',
...
// 
 jQuery(document).on("click", "#delete_entrytype", function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: base_url + "panel/expenses/delete_entrytype",
    ...
    jQuery(document).on("click", "#edit_entrytype", function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: base_url + "panel/expenses/getEntryTypeByID",
     ...
     $(function () {
      $('#entrytype_form').parsley({
        ...
        if (mode == "add") {
            url = base_url + "panel/expenses/add_entrytype";
            $.ajax({
                url: url,
                type: "POST",
                data:  dataString,
            ...
            url = base_url + "panel/expenses/edit_entrytype";
