  ...
  <div class="box-body">
     <?php echo validation_errors(); ?>
            <?php echo form_open(); ?>
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-4 input-field">
                        <div class="form-group">
                            ...
                            <input type="text" name="label" value="<?php echo set_value('label'); ?>" class="form-control" data-parsley-required="true" required="">
                        </div>
                    </div>
                    <div class="col-md-12 col-lg-12 input-field">
                      <div class="form-group all">
                          <div class="checkbox-styled checkbox-inline">
                              ...
                              <input type="checkbox" <?php echo set_value('universal') ? 'checked' : ''; ?> id="universal" name="universal" value="1">
                    ...
                    <div class="col-md-12 col-lg-4 input-field">
                      <div class="form-group">
                          ...
                          <input value="<?php echo set_value('value'); ?>"  name="value" class="form-control" type="text" placeholder="0" data-parsley-required="true" data-parsley-type="number"  />
                      </div>
                    </div>
                     <div class="col-md-12 col-lg-4 input-field">
                      <div class="form-group">
                ...
                <div class="col-md-12">
                  <?php echo form_submit('submit',lang('Add Plan'), 'class="btn btn-primary"' ); ?>
                </div>
              </div>
