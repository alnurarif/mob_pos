...
function plan(x) {
    ...
    return formatDecimal(value, 2) + " ("+type+")";
}
...
function groups(x) {
    ...
    $(document).ready(function () {
        oTable = $('#dynamic-table').dataTable({
            ...
            'sAjaxSource': '<?php echo site_url('panel/commission/getAllProductCommission/'); ?>',
...
jQuery(document).on("click", "#delete", function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: base_url + "panel/commission/delete_product",
...
<div class="box box-primary ">
    <div class="box-header with-border">
      <h3 class="box-title"><?php echo lang('commission/product');?></h3>
