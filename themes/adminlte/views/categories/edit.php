            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12">
                        <div class="form-group all">
                            ...
                            <input type="text"  value="<?php echo escapeStr($category->name); ?>" name="category_name" class="form-control">
                        </div>
                                ...
                                ?>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input type="text" class="category_name form-control" name="name[<?php echo $i;?>]"
...
<script type="text/javascript">
    $("#addup").on( "click", function(){
        var all = (document.querySelectorAll(".category_name").length);
        $.post("<?php echo base_url("panel/settings/addmore_categories");?>",
        {
            id: all,
        },
