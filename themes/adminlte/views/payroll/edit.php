...
/*
    #net_pay_distribution td .margin{
        margin-left: 25px;
    }

    #net_pay_distribution tr:first-child td b {
        margin-left: 16px;
...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title"><?php echo lang('Edit Payroll');?></h3>

        <div class="box-tools pull-right">

        </div>
    </div>
    <?php echo form_open_multipart('panel/payroll/edit/'.$payroll->id, 'autocomplete="off"'); ?>
    <input type="hidden" name="template_id" value="<?php echo $template->id; ?>">
    <input type="hidden" name="employee_name" id="employee_name" value="<?php echo escapeStr($payroll->employee_name);?>">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 col-xs-6 col-md-4">
                ...
                <div class="form-group">
                    ...
                    ?>
                    <label class="color_blue_bg">Staff</label>
                    <?php echo form_dropdown('user_id', $uarray, set_value('user_id', $payroll->user_id) ,array('class' => 'form-control select2','id'=>'user_id','placeholder'=>lang('Select Employee'))); ?>
                </div>
            </div>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 no-padding">
                                <?php echo form_input('from_date', set_value('date', $this->repairer->hrsd($payroll->from_date)), array('class' => 'form-control date', 'required'=>"required")); ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 no-padding">
                                <?php echo form_input('to_date', set_value('date', $this->repairer->hrsd($payroll->to_date)), array('class' => 'form-control date', 'required'=>"required")); ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-3 col-sm-6 col-xs-6 col-md-4">
                <div class="form-group">
                    ...
                    <?php echo form_input('business_name', set_value('business_name', $payroll->business_name), array('class' => 'form-control', 'id'=>"business_name",'required'=>"required"));?>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6 col-xs-6 col-md-4" style="display: none"> 
                ...
                <label for="recurring" class="active color_blue_bg"><?php echo lang('Recurring?');?></label>
                    ...
                    <div class="switch switch-sm switch-success">
                        <input type="checkbox" <?php echo $payroll->recurring ? 'checked' : '';?> class="toggle_on_off" value="1"  id="recurring" name="recurring" />
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-2 col-sm-6 col-xs-6 col-md-4 ">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <input class="form-control" id="recurF" name="recur_frequency" type="text" value="<?php echo escapeStr($payroll->recur_frequency);?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-sm-6 col-xs-6 col-md-4 ">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <?php 
                                    ...
                                    echo form_dropdown('recur_type', $recur,  $payroll->recur_type, 'class="form-control" id="recurT"');
                                ?>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-sm-6 col-xs-6 col-md-4 ">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <input class="form-control date" id="recur_start_date" name="recur_start_date" type="text" value="<?php echo date($dateFormats['php_sdate'], $payroll->recur_start_date);?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-2 col-sm-6 col-xs-6 col-md-4 ">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <input class="form-control date" id="recur_end_date" value="<?php echo date($dateFormats['php_sdate'], $payroll->recur_end_date);?>" name="recur_end_date" type="text">
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo form_input('template_metas['.$key->payroll_template_meta_id.']', $key->value, array('class' => 'form-control touchspin bottom_left', 'placeholder'=>"",'onkeyup'=>'refresh_totals()','id'=>'bottom_left'.$count)); ?>
                                                    </div>
                                                </td>
                                            </tr>
                               ...
                               <table width="100%" id="pre_tax_deductions">
                                        ...
                                        <?php foreach($bottom_right as $key): ?>
                                            <tr>
                                                ...
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo form_input('template_metas['.$key->payroll_template_meta_id.']', $key->value, array('class' => 'form-control touchspin bottom_right', 'placeholder'=>"",'onkeyup'=>'refresh_totals()','id'=>'bottom_right'.$count)); ?>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php $count++; endforeach; ?>
                                    ...
                                    <td width="70%" class="bg-gray">
                                        <table width="100%" id="gross_pay">
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo form_input('total_pay',$additions = $this->payroll_model->single_payroll_total_pay($payroll->id), array('class' => 'form-control', 'readonly'=>"",'id'=>'total_pay')); ?>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <td  class="bg-gray">
                                        <table width="100%" id="gross_pay">
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo form_input('total_deductions',$deductions = $this->payroll_model->single_payroll_total_deductions($payroll->id), array('class' => 'form-control', 'readonly'=>"",'id'=>'total_deductions')); ?>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <td class="bg-gray">
                                        <table width="100%" id="gross_pay">
                                            ...
                                            <tr>
                                                ...
                                                <td width="50%" class="cell_format">
                                                    <div class="margin text-bold">
                                                        <?php echo form_input('net_pay',$additions - $deductions, array('class' => 'form-control', 'readonly'=>"",'id'=>'net_pay')); ?>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                ...
                <div class="col-lg-3 col-sm-6 col-md-3 col-xs-12 no-padding">
                    <table width="100%" class="" id="net_pay_distribution">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo form_input('bank_name',set_value('bank_name', $payroll->bank_name), array('class' => 'form-control', 'id'=>"bank_name")); ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="50%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo form_input('account_number',set_value('account_number', $payroll->account_number), array('class' => 'form-control', 'id'=>"bank_account_number")); ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="50%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo form_input('sort_code',set_value('sort_code', $payroll->sort_code), array('class' => 'form-control', 'id'=>"sort_code")); ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="50%" class="cell_format">
                                        <div class="margin text-bold">
                                            <?php echo form_input('paid_amount',$additions - $deductions, array('class' => 'form-control', 'id'=>"paid_amount")); ?>
        ...
        <div class="row">
             <div class="col-lg-4 col-sm-6 col-xs-6 col-md-4 ">
                <div class="form-group">
                    ...
                    <?php echo form_input('comments', set_value('comments', $payroll->comments), array('class' => 'form-control', ''=>"")); ?>
                </div>
            </div>
        </div>
