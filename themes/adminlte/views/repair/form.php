...
jQuery(document).on("click", "#modify_reparation", function () {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if ($('#category_select option[value="'+data.category+'"]').length == 0) {
            ...
            <?php if($settings->use_defects_input_dropdown): ?>
                if($('#defect_id option[value="'+data.defect_id+'"]').length > 0) {
                    $('#defect_id').val(data.defect_id).trigger('change');
                }else{
            ...
            <?php if($settings->use_models_input_dropdown): ?>
                if($('#model_id option[value="'+data.model_id+'"]').length > 0) {
                    $('#model_id').val(data.model_id).trigger('change');
                }else if(data.model_name && data.model_name !== ''){
            ...
            if (!isEmptyObject(ci)) {
                ...
                $('#rprTable tbody').html("<tr><td colspan=\"4\"><?=lang('table_empty');?></td></tr>");
                loadRepairItems();
            }
            ...
            if(IS_JSON) {
                $.each(json, function(id_field, val_field) {
                    if(document.getElementById('checktoggle_'+id_field)){
                        if (parseInt(val_field) == 1) {
            ...
            <div class="col-sm-7" style="text-align: right;">
                ...
                <button id="upload_modal_btn" class="btn btn-default" data-mode="edit" data-num="${encodeURI(num)}" ><i class="fa fa-cloud"></i> <?php echo lang('view_attached');?></button>

                <button onclick="printBarcode()" class="btn btn-default"><i class="fa fa-print"></i> <?php echo lang('print_barcode');?></button>
                ...
                <button id="repair_submit" data-mode="modify" data-num="${encodeURI(num)}" form="rpair_form" class="btn btn-success"><i class="fas fa-save"></i>    <?php echo lang("edit_repair"); ?>
                </button>
            </div>`;
    ...
    jQuery(".add_repair").on("click", function (e) {
        ...
        $("#status_edit").val($("#status_edit option:first").val()).trigger('change');
            ...
            <div class="modal-body">
                <form id="rpair_form" class="parsley-form">
                    ...
                    <div class="row">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select required="" id="client_name" name="client_name" data-num="1" class="form-control client_name" style="width: 100%">
                                            ...
                                            <?php
                                                ...
                                                echo '<option data-phone="'.$client->telephone.'" data-name="'.$client->first_name . ' ' . $client->last_name .'" value="'.$client->id.'">'.$client->first_name.' '.$client->last_name.' '.preg_replace('~.*(\d{3})[^\d]{0,7}(\d{3})[^\d]{0,7}(\d{4}).*~', '($1) $2-$3', $client->telephone).'</option>';
                                                endforeach;
                                            ?>
                                        </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <?php else:?>
                                    <div class="form-group">
                                        <div class="form-group">
                                            <?php echo lang('repair_model', 'model');?><font color="#FF0017"> *</font>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fas  fa-folder"></i>
                                                </div>
                        ...
                        <div class="row">
                            ...
                            <?php if(@$settings->use_defects_input_dropdown):?>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <?php echo lang('repair_defect', 'defect');?><font color="#FF0017"> *</font>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label><?php echo lang('Assign Repair To');?></label><font color="#FF0017"> *</font>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fas  fa-folder"></i>
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 input-field">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('warranty_id', $tr, '', 'class="form-control tip" id="warranty_id" style="width:100%;" ');
                                    ?>
                               </div>
                            </div>
                           <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-styled">
                                        ...
                                        <input type="checkbox" class="skip" value="1" name="email" id="repair_email">
                    ...
                    <div class="col-lg-12">
                        ...
                        <hr>
                        <div class="form-group">
                            <?php echo lang('repair_comment', 'comment'); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="advance" name="advance" type="text" value="0" class="validate form-control" placeholder="<?=lang('repair_advance');?>">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <?php if(!$settings->disable_labor): ?>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="service_charges" name="service_charges" type="text" value="0" class="validate form-control" placeholder="<?=lang('repair_service_charges');?>" >
                                    </div>
                                </div>
                                ...
                                <div class="control-group table-group">
                                    ...
                                    <div class="controls table-controls">
                                        <table id="rprTable"
                                            ...
                                            <thead>
                                            <tr>
                                                <th class="col-md-5"><?php echo lang("product_name"); ?></th>
...
<script type="text/javascript">
    function calculate_price(tax = false) {
        ...
        $.each(tax_rates, function () {
            if (parseInt(this.id) == parseInt(potax2)) {
        ...
        $('#price_span').html(formatDecimal((parseFloat(pp ? pp : 0)), 2));
        $('#totalprice_span').html(formatDecimal(parseFloat(pp ? pp : 0) + parseFloat(service_charges), 2));
        total = parseFloat($('#totalprice_span').html());

        $('#sc_span').html(formatDecimal(service_charges));
        $('#gtotal').html(formatDecimal(parseFloat(total)+ parseFloat(pt ? pt : 0) + parseFloat(sc_tax)));


        $('#tax_spane').html(formatMoney(sc_tax) + parseFloat(pt ? pt : 0));

        var deposit = parseFloat($('#advance').val());
        $('#deposit_span').html(formatDecimal(deposit));
        $('#balance_span').html(formatDecimal(parseFloat(total) - formatDecimal(deposit)));
        return true;
    }
...
<script type="text/javascript">
    $(document).ready(function () {
         $("#serial_number, #add_r_item").keypress(function(event){
        ...
        $('#client_name').on("select2:select", function(e) {
         ...
         $(document).on('click', '#add_product_row', function(e) {
            ...
            add_product_item({
                ...
                pr_tax: null,
                price: "0",
                product_id: "manual" + jQuery.now(),
                purchase_type: false,
                qty: "0",
                row_id: "manual" + jQuery.now(),
                serial_number: null,
                serial_search: true,
                serialed: true,
                set_reminder: null,
