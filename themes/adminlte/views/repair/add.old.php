...
<div class="box box-primary ">
    <div class="box-header with-border">
      <h3 class="box-title"><?php echo lang('add_repair');?></h3>
    </div>
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-3" style="padding-left: 0;">
                <input id="code" name="code" type="text" class="validate form-control" value="<?php echo $this->repairer->getReference('repair');?>" placeholder="<?php echo lang('repair_code');?>">
            </div>
            <div class="col-sm-7" style="text-align: right;">
                <a href="<?php echo base_url();?>/panel/repair" class="btn btn-default" type="button"><i class="fas fa-reply"></i> <?php echo lang('go_back'); ?></a>
                ...
                <button id="submit" form="rpair_form" class="btn btn-success"><i class="fas fa-plus-circle"></i>    <?php echo lang("add"); ?> <?php echo lang("repair_title"); ?>
                </button>
            </div>
        </div>
        </form>
    ...
    $('#rpair_form').on( "submit", function(event) {
        ...
        if (parseInt(status_code) == 2 || parseInt(status_code) == 0) {
            if (localStorage.getItem('to_order')) {
                ...
                if (order_items) {
                    bootbox.alert("<?php echo lang('Cannot Submit because some of the items are not in stock');?>")
                    return false;
                    exit();
                }
            }
