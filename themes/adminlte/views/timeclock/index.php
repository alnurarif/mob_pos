...
<div class="box">
    ...
    <h3 class="box-title"><?php echo lang('timeclock/index');?></h3>
    </div>
    <div class="box-body">
        <form id="pin_form">
...
<?php echo form_open('panel/timeclock/view', array('id'=> 'timeclock_tt')); ?>
...
<script type="text/javascript">
    ...
    jQuery(document).on("click", "#submit_pin", function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: base_url + "panel/timeclock/getSortMenu",
